...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Adeeb' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? 't' : process.env.TAG_REPLY,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ ADP BOT ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
